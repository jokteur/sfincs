...
def run(context):
    ...
    skipExistingDirectories = context['sskipExistingDirectories']
    ...
    readDefault = sfincsScan_common.readDefault
    ...
    context['radiusName'] = radiusName
    context['radiusNameForGradients'] = radiusNameForGradients
    context['Nspecies'] = Nspecies
    context['nHats'] = nHats
    context['dnHatdradii'] = dnHatdradii
    context['THats'] = THats
    context['dTHatdradii'] = dTHatdradii
    context['NErs'] = NErs
    context['generalErName'] = generalErName
    context['generalEr_max'] = generalEr_max
    context['generalEr_min'] = generalEr_min
