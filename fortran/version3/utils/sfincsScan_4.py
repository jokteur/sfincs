...
from radialScans import *
import common
from common import namelistLineContainsSS, namelistLineContains
import subprocess

def make_scan(
    waitBeforeSubmitting: bool,
    inputFile: list,
    nameJobFile,
    submitCommand: str,
):
    ...
    common.skipExistingDirectories = True
    ...
    with open(common.jobFilename, 'r') as f:
        jobFile = f.readlines()
